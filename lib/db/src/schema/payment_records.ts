...
export const paymentRecordsTable = pgTable("payment_records", {
  ...
  studentEmail: text("student_email").default(""),
  courseName: text("course_name").default(""),
  proofImage: text("proof_image"),
  proofAnalysis: jsonb("proof_analysis"),
  adminNotes: text("admin_notes"),
  approvedBy: text("approved_by"),
  approvedAt: timestamp("approved_at", { withTimezone: true }),
  transactionNumber: text("transaction_number").default(""),
  paymentDate: text("payment_date").default(""),
  senderNumber: text("sender_number").default(""),
});
