      ...
      <div className="max-w-4xl mx-auto space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">Personalized Quran learning schedule generated by AI</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <Card className="border-emerald-100">
            <CardContent className="p-4 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="font-bold text-emerald-950">{dailyGoal} minutes</p>
              </div>
            </CardContent>
          </Card>
          <Card className="border-emerald-100">
          ...
          <Card className="border-emerald-100">
            <CardContent className="p-4 flex items-center gap-3">
              ...
              <div>
                <p className="text-xs text-muted-foreground">Hifdh Surahs</p>
        ...
        {goals.length > 0 && (
          <div className="flex flex-wrap items-center gap-2">
            <span className="text-sm text-muted-foreground">Your goals:</span>
            {goals.map(g => (
        ...
        {!plan && !isGenerating ? (
          <Card className="border-emerald-100 border-dashed">
            <CardContent className="p-12 flex flex-col items-center text-center gap-4">
              ...
              <div>
                <h3 className="font-semibold text-lg text-emerald-950">Generate Your Plan</h3>
                <p className="text-sm text-muted-foreground mt-1 max-w-sm">
                  AI will analyze your level, goals, Hifdh progress, and available time to create a personalized 7-day Quran study plan.
                </p>
              </div>
