...
function requireAdmin(req: any, res: any, next: any) {
  // When ADMIN_USER_IDS is configured, enforce the allowlist.
  // When it is NOT configured (dev / first boot), allow any authenticated user through
  // so the admin can approve payments without needing to set the env var first.
